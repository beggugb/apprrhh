      ...
      <Row className="mt-1">           
          ...
          <CardHeader>
            <div className="card-icono"><FontAwesomeIcon icon={faHeadset} /></div>
              <CardTitle className="text-dark mt-2"> TICKETS </CardTitle>
              <p>{ticketT.total}</p>                                   
              </CardHeader>
          </Card>    
          </Col>
          ...
          <CardHeader>
            <div className="card-icono"><FontAwesomeIcon icon={faBookmark} /></div>
              <CardTitle className="text-dark mt-2"> PROMOCIONES </CardTitle>
          ...
          <Card className="card-repo">
          <CardHeader>
            <div className="card-icono"><FontAwesomeIcon icon={faDollarSign} /></div>
